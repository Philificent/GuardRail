...
(async () => {
  ...
  await page.evaluate(() => {
    return new Promise((resolve) => {
      ...
      iframe.src = 'data:text/html,<html><body><script>parent.postMessage({ type: "GUARDRAIL_MEDIA_INTERNAL" }, "*");</script></body></html>';
  ...
  if (receivedMessages.length === 0) {
    ...
    console.error('Invalid case failed: Malicious message was processed!', receivedMessages);
    process.exit(1);
  }
